...
The DPD resources are synthetic training data and were not used as clinical evaluation datasets.

**Availability:**  
The DPD synthetic dataset and associated pre-training prompt templates will be made publicly available in this repository upon acceptance of the manuscript.
...
**DPT-PT** contains 99,000 instruction–response pairs used for domain pre-training. Unlike DPD, DPT was not generated by a large language model. It was constructed through **physics-guided and structured rule-based synthesis** based on **22 predefined dietary patterns** and their corresponding nutritional rules and constraints.
...
**Availability:**  
The DPT synthetic dataset and associated pre-training prompt templates will be made publicly available in this repository upon acceptance of the manuscript.
...
**Availability:**  
The QF-KG schema will be publicly released in this repository upon acceptance. Source materials subject to third-party copyright or licensing restrictions will not be redistributed.
...
The mini program provides an implementation interface for personalized dietary planning based on the DietOpt-SLM framework.

The current study establishes evidence regarding technical feasibility, nutritional and safety-constraint adherence, repeated-run reproducibility, expert-panel prescription-level agreement, professional plausibility, and preliminary user-perceived acceptability.

The current evidence should **not** be interpreted as demonstrating clinical efficacy.

---

# Prospective Clinical Research

The next stage of this project will evaluate DietOpt-SLM through **prospective clinical research** in relevant non-communicable disease settings.

Future studies are planned to investigate DietOpt-SLM-assisted dietary planning under real-world clinical workflows with longitudinal follow-up.

These prospective evaluations will focus on outcomes including:

- dietary adherence;
- implementation feasibility;
- clinician and participant usability;
- longitudinal nutritional outcomes;
- relevant cardiometabolic endpoints;
- performance across predefined demographic and clinical subgroups.

Potential clinical endpoints may include measures such as glycaemic control, blood pressure, lipid profiles, body weight, and other disease-relevant outcomes depending on the study population and protocol.

The mini program is therefore currently provided as a **research-facing implementation platform for prospective evaluation**, rather than as a clinically validated treatment product.
